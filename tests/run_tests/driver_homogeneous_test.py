...
from simpeg_drivers.homogeneous.driver import HomogeneousDriver
...
def test_homogeneous_run(
    ...
    with Workspace(workpath, mode="r+") as geoh5:
        ...
        params = HomogeneousOptions(
            geoh5=geoh5, inversion_group=grav_group, mesh=mesh, geo_model=geo_model
        )
        driver = HomogeneousDriver(params)
        driver.run()
